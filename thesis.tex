...
% Title Page
\renewcommand{\enTitle}{Question Answering expressed answer in short text based on Sequence to Sequence Network}  %英文標題
\renewcommand{\zhTitle}{基於序列對序列網路之問答系統以簡短文字表達}  %中文標題
...
\chapter{以專注式記憶編碼解碼器實現描述式問答系統}
  \input{chapters/chapter3}
\chapter{以遞迴式網路與卷積神經網路之基於查詢詞偵檢測}
